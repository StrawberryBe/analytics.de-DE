...
| [!UICONTROL **Häufig mit**] | Zeigt die fünf Komponenten an, die am häufigsten mit der Komponente verwendet werden, die Sie anzeigen. Diese Liste basiert auf Daten aus den letzten 90 Tagen. Es werden nur Komponenten angezeigt, auf die Sie Zugriff haben. |
| [!UICONTROL **Ähnlich wie**] | Zeigt 5 Komponenten mit ähnlichen Bezeichnungen wie die angezeigte Komponente an. Es werden nur Komponenten angezeigt, auf die Sie Zugriff haben. |
