...
| `ipv6` | Die komprimierte IPv6-Adresse, falls verfügbar. Wenn eine IP-Adresse ungefähr `2001:cDBa:0000:0000:0000:0000:3257:0052`, enthält der Daten-Feed `2001:cdba::3257:52`. Gegenseitig ausschließlich für `ip`; wenn diese Spalte eine nicht verschleierte IP-Adresse enthält, `ip` leer ist. | varchar(40) |
