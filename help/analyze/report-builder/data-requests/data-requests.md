...
1. **[!UICONTROL Report Suite:]** Die Liste der für Sie aufgrund Ihrer Anmeldeangeben verfügbaren Report Suites. See [Select Report Suites](/help/analyze/report-builder/data-requests/selecting-report-suites/t-select-report-suites.md).

1. **Bereichsauswahl:** Hier können Sie eine Report Suite ID aus einer Zelle in Excel auswählen. See [Select Report Suites](/help/analyze/report-builder/data-requests/selecting-report-suites/t-select-report-suites.md).
