...
| Auf aktuelles Datum festlegen | Damit können Sie die  [!UICONTROL Ausführungsdatum] sodass der Report Builder das aktuelle Datum verwendet oder fragt, welches Datum für die Aktualisierung verwendet werden soll. |
