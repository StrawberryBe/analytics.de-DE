...
| **[!UICONTROL Verlaufstransparenz]** | Wählen Sie die Transparenzstufe für Verlaufsüberlagerungen. Diese Einstellung wirkt sich nicht auf die [!UICONTROL Blase]-Überlagerungen aus. |
...
| Einstellung | Beschreibung |
|---|---|
| **[!UICONTROL Anzeige oben]** | Um **[!UICONTROL Gewinner]** oder **[!UICONTROL Verlierer]** (oder beides) als Überlagerungen anzuzeigen, wählen Sie die Anzahl der Links aus. |
