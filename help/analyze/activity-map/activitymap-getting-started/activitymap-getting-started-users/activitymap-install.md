...
1. Wenn das Adobe Analytics-Symbol  in Ihrer Symbolleiste angezeigt wird, war der Download erfolgreich. <br/><img src="./assets/an_icon.png" width="150px"/><br/>Jetzt können Sie auf Ihrer Seite [Activity Map starten](/help/analyze/activity-map/activitymap-getting-started/activitymap-getting-started-users/activitymap-launch.md).
