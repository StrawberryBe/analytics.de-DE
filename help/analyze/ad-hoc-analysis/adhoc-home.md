...
seo-title: Übersicht über Ad Hoc Analysis
solution: Analytics
...
* Sie können Ihre Ad-hoc-Analysen-Projekte jetzt nahtlos in Projekte im Arbeitsbereich für Analysen konvertieren. Gehen Sie zum [Ad-hoc-Analysen-Projektkonverter-Überblick](/help/analyze/ad-hoc-analysis/c-aha-project-converter/aha2aw-overview.md) , um herauszufinden, wie!
* Sehen Sie sich den Abschnitt [Ad Hoc Analysis im Vergleich mit Analysis Workspace](/help/analyze/analysis-workspace/adhocanalysis-vs-analysisworkspace.md) an: Analysis Workspace bietet viele der Funktionen von Ad Hoc Analysis im Browser-Workflow. Einige Begriffe und Funktionen werden zwischen den Produkten übernommen, doch es gibt auch einige neue Begriffe und Ansätze für Analysen, die in Analysis Workspace neu eingeführt werden.
* [Administration](/help/analyze/ad-hoc-analysis/c-administration.md): Erfahren Sie, wie Sie Benutzer und Musterdaten konfigurieren.
