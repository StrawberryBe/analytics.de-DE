...
| Option | Beschreibung |
|--- |--- |
| Berichtsdateiname | Gibt den Namen des Berichts an. Das Standardformat ist `<report name> for <suite> - <report date range>`. To specify a custom name, select [!UICONTROL Custom]. |
