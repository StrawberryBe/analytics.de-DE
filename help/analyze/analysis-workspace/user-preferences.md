...
>[!AVAILABILITY]
>
>Die in diesem Abschnitt beschriebene Funktion für öffentliche Zugriffslinks befindet sich in der Phase der eingeschränkten Testphase der Veröffentlichung. Diese Anmerkung wird entfernt, wenn die Funktion allgemein verfügbar ist. Informationen zum Analytics-Veröffentlichungsprozess finden Sie unter [Adobe Analytics-Funktionsversionen](/help/release-notes/releases.md).
...
| **Öffentliche Zugriffslinks** <!-- Double check the names of all these settings for what they are actually called --> |  |  |
|  | Alle öffentlichen Zugriffslinks deaktivieren | <p>Verhindert, dass Benutzer in Ihrer Organisation Analysis Workspace-Projekte für Personen freigeben, die kein Analysis Workspace-Konto haben. Benutzer können Projekte nur für andere Analysis Workspace-Benutzer in Ihrer Organisation freigeben.</p> <p>Wenn öffentliche Links deaktiviert sind:</p> <ul><li><p>Benutzer können keine öffentlichen Zugriffslinks erstellen</p><p>Die Option &quot;Öffentlichen Link freigeben&quot;wurde aus dem Menü &quot;Freigeben&quot;entfernt. Das bedeutet, dass Benutzer keine Projekte mehr für Personen freigeben können, die kein Analysis Workspace-Konto in Ihrer Organisation haben, wie unter [Öffentlichen Link für alle freigeben (keine Anmeldung erforderlich)](/help/analyze/analysis-workspace/curate-share/share-projects.md#share-public-link) in [Freigeben von Projekten](/help/analyze/analysis-workspace/curate-share/share-projects.md).</p></li> <li><p>Alle vorhandenen öffentlichen Links sind deaktiviert</p></li><p>Wenn öffentliche Links deaktiviert und dann erneut aktiviert werden, werden alle zuvor deaktivierten Links nicht automatisch reaktiviert. In diesem Fall müssen Benutzer sie für jedes Projekt manuell im Dialogfeld Projekt freigeben reaktivieren.</p> |
|  | Passwort erfordern | <p>Erzwingt, dass Benutzer in Ihrer Organisation beim Erstellen öffentlicher Links einen Kennwortschutz benötigen.</p> <p>Wenn diese Option aktiviert ist, wird jedes Mal, wenn ein Benutzer einen öffentlichen Link zu einem Analysis Workspace-Projekt erstellt, die Option &quot;Kennwort erforderlich&quot;im Dialogfeld &quot;Freigeben&quot;aktiviert und kann vom Benutzer nicht deaktiviert werden. (Informationen dazu, wie Benutzer Projekte für Benutzer außerhalb der Organisation freigeben können, finden Sie unter [Öffentlichen Link für alle freigeben (keine Anmeldung erforderlich)](/help/analyze/analysis-workspace/curate-share/share-projects.md#share-public-link) in [Freigeben von Projekten](/help/analyze/analysis-workspace/curate-share/share-projects.md).</p><p>Beachten Sie beim Aktivieren dieser Option Folgendes:</p> <ul><li><p>Wenn Sie diese Option aktivieren, werden alle derzeit aktiven öffentlichen Links, für die kein Kennwortschutz aktiviert ist, deaktiviert.</p></li> <li><p>Wenn diese Option aktiviert und später deaktiviert ist, werden alle zuvor deaktivierten Links nicht automatisch reaktiviert. In diesem Fall müssen Benutzer sie manuell im Dialogfeld Projekt freigeben erneut aktivieren.</p></li></ul> |
|  | Authentifizierung für Single Sign-On erforderlich | <p>Erfordert Single Sign-On (SSO)-Authentifizierung für alle öffentlichen Links. Wenn diese Option aktiviert ist, können nur Empfänger, die über eine Federated ID verfügen und sich bei Experience Cloud anmelden können, auf freigegebene öffentliche Links zugreifen.</p> <p>Wenn diese Option aktiviert ist, wird jedes Mal, wenn ein Benutzer einen Link zu einem Analysis Workspace-Projekt erstellt, die Option &quot;Single Sign-on (SSO)-Authentifizierung erforderlich&quot;im Freigabedialogfeld aktiviert und kann vom Benutzer nicht deaktiviert werden. (Informationen dazu, wie Benutzer Projekte für Benutzer außerhalb der Organisation freigeben können, finden Sie unter [Öffentlichen Link für alle freigeben (keine Anmeldung erforderlich)](/help/analyze/analysis-workspace/curate-share/share-projects.md#share-public-link) in [Freigeben von Projekten](/help/analyze/analysis-workspace/curate-share/share-projects.md).</p> <p>Beachten Sie beim Aktivieren dieser Option Folgendes:</p><ul><li><p>Wenn Sie diese Option aktivieren, werden alle derzeit aktiven öffentlichen Links, für die SSO nicht aktiviert ist, deaktiviert.</p></li> <li><p>Wenn diese Option aktiviert und später deaktiviert ist, werden alle zuvor deaktivierten Links nicht automatisch reaktiviert. In diesem Fall müssen Benutzer sie manuell im Dialogfeld Projekt freigeben erneut aktivieren.</p></li> <li><p>Diese Option ist nur verfügbar, wenn SSO in Ihrem Unternehmen implementiert ist. Informationen dazu, wie Systemadministratoren SSO für Ihr Unternehmen aktivieren können, finden Sie unter [Einrichten der Identität und Single Sign-On](https://helpx.adobe.com/de/enterprise/using/set-up-identity.html){target=_blank}.</p><p>Wenn die einmalige Anmeldung für Ihr Unternehmen konfiguriert ist, überprüfen Sie, ob in der Konsole eine automatische Kontoerstellung implementiert ist. Normalerweise würde ein Systemadministrator dies einrichten, wie unter [Automatische Kontoerstellung aktivieren](https://helpx.adobe.com/enterprise/using/automatic-account-creation.html){target=_blank}.</p></li><li><p>Wenn Ihr Unternehmen in einer Branche tätig ist, die HIPAA-Compliance erfordert, wird diese Option automatisch aktiviert und kann nicht deaktiviert werden.</p></li></ul> |
|  | Anzeigen der Option &quot;Authentifizierung bei Single Sign-On erforderlich&quot; für Benutzer | <p>Wenn die Option &quot;Single Sign-On-Authentifizierung erforderlich&quot;deaktiviert ist, können Sie diese Option auswählen, damit Benutzer in Ihrer Organisation entscheiden können, ob sie für freigegebene Projekte eine Single Sign-On-Authentifizierung benötigen möchten. In diesem Fall ist die Option &quot;Single Sign-on (SSO) Authentifizierung erforderlich&quot;jedes Mal, wenn ein Benutzer einen Link zu einem Analysis Workspace-Projekt erstellt, im Freigabedialogfeld aktiviert. Benutzer können sie bei Bedarf deaktivieren.<!--or is this disabled by default?--> (Informationen dazu, wie Benutzer Projekte für Benutzer außerhalb der Organisation freigeben können, finden Sie unter [Öffentlichen Link für alle freigeben (keine Anmeldung erforderlich)](/help/analyze/analysis-workspace/curate-share/share-projects.md#share-public-link) in [Freigeben von Projekten](/help/analyze/analysis-workspace/curate-share/share-projects.md).</p><p>Wenn die Option &quot;Single Sign-on-Authentifizierung erforderlich&quot;aktiviert ist, ist diese Option zur Anzeige für Benutzer ausgewählt und kann nicht deaktiviert werden.</p><p>Beachten Sie bei Auswahl dieser Option Folgendes:</p><ul><li><p>Diese Option ist nur verfügbar, wenn SSO in Ihrem Unternehmen implementiert ist. Informationen dazu, wie Systemadministratoren SSO für Ihr Unternehmen aktivieren können, finden Sie unter [Einrichten der Identität und Single Sign-On](https://helpx.adobe.com/de/enterprise/using/set-up-identity.html){target=_blank}.</p><p>Wenn die einmalige Anmeldung für Ihr Unternehmen konfiguriert ist, überprüfen Sie, ob in der Konsole eine automatische Kontoerstellung implementiert ist. Normalerweise würde ein Systemadministrator dies einrichten, wie unter [Automatische Kontoerstellung aktivieren](https://helpx.adobe.com/enterprise/using/automatic-account-creation.html){target=_blank}.</p></li><li><p>Wenn Sie diese Option auswählen und ein Benutzer die Authentifizierung für die einmalige Anmeldung erfordert, können nur Empfänger, die über eine verknüpfte ID verfügen und sich bei Experience Cloud anmelden können, auf freigegebene öffentliche Links zugreifen.</p></li></ul> |
