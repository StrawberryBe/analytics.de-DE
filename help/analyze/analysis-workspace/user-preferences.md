...
| **Projektfreigabe** <!-- Double check the names of all these settings for what they are actually called --> |  |  |
|  | Freigabe nur für Arbeitsbereich-Benutzende zulassen | <p>Wenn diese Option aktiviert ist, können Benutzer in Ihrer Organisation die Option &quot;Mit anderen teilen&quot;nicht im Menü &quot;Freigeben&quot;sehen. Das bedeutet, dass Benutzer keine Projekte für Personen freigeben können, die kein Analysis Workspace-Konto in Ihrer Organisation haben, wie unter [Projekt für andere freigeben (keine Anmeldung erforderlich)](/help/analyze/analysis-workspace/curate-share/share-projects.md#share-public-link) in [Freigeben von Projekten](/help/analyze/analysis-workspace/curate-share/share-projects.md).</p><p>Diese Option ist standardmäßig für alle Organisationen deaktiviert (d. h. Benutzer können Projekte für Personen außerhalb der Organisation freigeben), mit Ausnahme der in der Gesundheitsbranche tätigen Personen. </p><p>Beachten Sie beim Aktivieren oder Deaktivieren dieser Option Folgendes:</p> <ul><li><p>Wenn Sie diese Option aktivieren, können Personen, die zuvor über die Freigabe-Option &quot;Mit jedem teilen&quot;Zugriff auf ein Projekt erhalten haben, nicht mehr auf das Projekt zugreifen.</p></li><li><p>Wenn diese Option aktiviert ist (um die Freigabe nur für Workspace-Benutzer zuzulassen) und später deaktiviert wird (um die Freigabe für andere zuzulassen), erhalten Personen, die zuvor über die Freigabe-Option &quot;Mit anderen teilen&quot;Zugriff auf ein Projekt erhalten haben, nicht automatisch wieder Zugriff auf das Projekt. In diesem Fall muss der Benutzer, der das Projekt freigegeben hat, die [!UICONTROL **Link ist aktiv**] Option, die beim Freigeben eines Projekts für andere verfügbar ist ([!UICONTROL **Freigeben**] > [!UICONTROL **Für alle freigeben**]), wie unter [Projekt für andere freigeben (keine Anmeldung erforderlich)](/help/analyze/analysis-workspace/curate-share/share-projects.md#share-public-link) in [Freigeben von Projekten](/help/analyze/analysis-workspace/curate-share/share-projects.md).</p></li><li><p>**Für Organisationen der Gesundheitsbranche:** Diese Option ist standardmäßig aktiviert und abgeblendet. Bevor Sie diese Option deaktivieren können, damit Benutzer die Freigabeoption &quot;Mit jedem teilen&quot;verwenden können, müssen Sie zunächst die [!UICONTROL **Projektlinks für alle freigeben**] Berechtigung (unter [!UICONTROL **Analytics-Tools**]) in der Adobe Admin Console. Nachdem die Berechtigung hinzugefügt wurde, können Sie diese Option deaktivieren und dann den resultierenden rechtlichen Hinweis akzeptieren. Informationen zum Hinzufügen einer Berechtigung zur Admin Console finden Sie unter [Verwalten von Produktberechtigungen in der Admin Console](https://helpx.adobe.com/de/enterprise/using/manage-permissions-and-roles.html).</p></li> |
|  | Experience Cloud-Authentifizierung erfordern | <p>Wenn diese Option aktiviert ist, müssen sich Personen, die über die Option &quot;Mit jedem teilen&quot;in Analysis Workspace Zugriff auf ein Experience Cloud erhalten, mit ihren Anmeldeinformationen authentifizieren.</p> <p>Wenn diese Option aktiviert ist, wird jedes Mal, wenn ein Benutzer ein Experience Cloud mithilfe der Freigabeoption &quot;Mit jedem teilen&quot;teilt, die Option &quot;Authentifizierung für dieses Projekt erforderlich&quot;im Freigabedialogfeld aktiviert und kann nicht von dem Benutzer deaktiviert werden, der das Projekt freigegeben hat. (Informationen dazu, wie Benutzer Projekte für andere freigeben können, finden Sie unter [Projekt für andere freigeben (keine Anmeldung erforderlich)](/help/analyze/analysis-workspace/curate-share/share-projects.md#share-public-link) in [Freigeben von Projekten](/help/analyze/analysis-workspace/curate-share/share-projects.md).</p> <p>Beachten Sie beim Aktivieren dieser Option Folgendes:</p><ul><li><p>Wenn Sie diese Option aktivieren, werden alle Projekte, die zuvor mit der Freigabeoption &quot;Mit jedem teilen&quot;freigegeben wurden und für die die Option &quot;Experience Cloud-Authentifizierung erforderlich&quot;nicht aktiviert ist, deaktiviert.</p></li> <li><p>Wenn diese Option aktiviert ist (d. h. eine Projektauthentifizierung erforderlich ist) und später deaktiviert wird (damit alle Benutzer mit dem Link auf das Experience Cloud zugreifen können), erhalten Personen, die zuvor über die Freigabeoption &quot;Mit jedem teilen&quot;Zugriff auf ein Projekt erhalten haben, nicht automatisch wieder Zugriff auf das Projekt. In diesem Fall muss der Benutzer, der das Projekt freigegeben hat, die Option &quot;Link ist aktiv&quot;aktivieren, die verfügbar ist, wenn er ein Projekt für andere freigegeben hat ([!UICONTROL **Freigeben**] > [!UICONTROL **Für alle freigeben**] > [!UICONTROL **Link ist aktiv**]), wie unter [Projekt für andere freigeben (keine Anmeldung erforderlich)](/help/analyze/analysis-workspace/curate-share/share-projects.md#share-public-link) in [Freigeben von Projekten](/help/analyze/analysis-workspace/curate-share/share-projects.md).</p></li> <li><p>Diese Option ist nur verfügbar, wenn SSO in Ihrem Unternehmen implementiert ist. Informationen dazu, wie Systemadministratoren SSO für Ihr Unternehmen aktivieren können, finden Sie unter [Einrichten der Identität und Single Sign-On](https://helpx.adobe.com/de/enterprise/using/set-up-identity.html){target=_blank}.</p><p>Wenn die einmalige Anmeldung für Ihr Unternehmen konfiguriert ist, überprüfen Sie, ob in der Konsole eine automatische Kontoerstellung implementiert ist. Normalerweise würde ein Systemadministrator dies einrichten, wie unter [Automatische Kontoerstellung aktivieren](https://helpx.adobe.com/enterprise/using/automatic-account-creation.html){target=_blank}.</p></li><li><p>Wenn Ihr Unternehmen in einer Branche tätig ist, die HIPAA-Compliance erfordert, wird diese Option automatisch aktiviert und kann nicht deaktiviert werden.</p></li></ul> |
