...
description: 'Attribution IQ ist eine Reihe von Funktionen in Adobe Analytics, die zusätzliche Einblicke in den Beitrag von Marketing-Maßnahmen zur Konversion bieten. '
...
Attribution IQ ist eine Reihe von Funktionen in Adobe Analytics, die zusätzliche Einblicke in den Beitrag von Marketing-Maßnahmen zur Konversion bieten.
...
Mit Adobe Analytics Attribution IQ können moderne Datenerfassungs-Teams nachvollziehen, wann während der Customer Journey eine aussagekräftige Interaktion erfolgt, und Wendepunkte identifizieren, durch die Kunden zu den gewünschten Handlungen gelangen. Durch das Verständnis dieses Aspekts der Customer Journey werden Marketing-Initiativen effektiv optimiert.
...
* Erstellen Sie berechnete Metriken: eine beliebige Anzahl von Zuordnungsmethoden verwenden.

## Funktionen {#features}

Attribution IQ umfasst die folgenden Funktionen:

* [Attributionsbedienfeld:](c-panels/attribution/attribution.md)
