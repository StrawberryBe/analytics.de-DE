...
seo-title: Flussvisualisierung konfigurieren
...
Wenn Sie auf einen Knoten in dem Diagramm klicken, werden die zugehörigen Details zu diesem Knoten angezeigt. Beispiel: Wenn Sie in dem oben gezeigten Diagramm auf **[!UICONTROL Suchergebnisse]rechts oben klicken, wird das Diagramm um weitere Details zu dem Suchergebnisknoten erweitert.** Klicken Sie erneut auf den Knoten, um ihn wieder zu reduzieren.

![](assets/flow3.jpg)

In der Standardeinstellung zeigt das Diagramm die obersten fünf Flüsse an. Wenn Sie unten im Diagramm auf den Knoten **[!UICONTROL Mehr]klicken, wird das Diagramm um fünf weitere Flüsse erweitert.** Wenn Sie noch weiter auf **[!UICONTROL Mehr]klicken, wird das Diagramm zunehmend erweitert, bis keine weiteren Flüsse mehr zur Anzeige vorhanden sind.**

Es gibt keine Einschränkungen dafür, wie oft Sie das Flussdiagramm erkunden können.
