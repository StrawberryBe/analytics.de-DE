...
1. Bearbeiten Sie das Segment im [Segment Builder](https://marketing.adobe.com/resources/help/de_DE/analytics/segment/seg_build.html) weiter und klicken Sie anschließend auf **[!UICONTROL Speichern]**.
