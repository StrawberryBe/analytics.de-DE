...
[!UICONTROL Mit den Spalteneinstellungen] können Sie die Spaltenformatierung konfigurieren, von denen einige bedingt sein können.

## Einstellungen [!UICONTROL für Spalten bearbeiten] {#column-settings}
