...
* **Anzahl der Metriken**: Mit der steigenden Anzahl von Metriken nimmt die Berichtslaufzeit zu. Durch Entfernen von Metriken kann die Berichtgenerierungszeit häufig verbessert werden.
