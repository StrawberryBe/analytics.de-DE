...
Nachdem Sie sich bei Adobe Experience Cloud und Analytics angemeldet haben, aktivieren Sie die Schaltfläche [!UICONTROL Neue Landingpage - Beta] in der unteren linken Ecke. Der Zugriff auf die Umschalt-Schaltfläche ist benutzerspezifisch innerhalb der Organisation und nicht unternehmensspezifisch.
...
![Landing (alle)](assets/landing-all.png)
...
![Registerkarte „Berichte“](assets/reports-tab.png)
...
| **[!UICONTROL Unternehmensberichte]** | Berichte, die Ihr Unternehmen für Ihre Verwendung erstellt hat. Siehe unten &quot;Erstellen eines Unternehmensberichts&quot;. |

### Speicherort der Vorlagen (jetzt als Berichte bezeichnet)

| Name des Berichts (Vorlage) | Berichtsort |
| --- | --- |
| Anleitungsvideo | Bevorzugte > Schulungs-Tutorial |
| Web Content-Nutzung | Interaktion > Web Content-Nutzung |
...
| Webaufbewahrung | Interaktion > Web-Treue |
| Medien-Audionutzung | Interaktion > Medien-Audio-Nutzung |
| Medienneuigkeit, Häufigkeit, Treue | Interaktion > Medienneuigkeit, Häufigkeit, Treue |
| Auswirkungen von ITP | Interaktion > ITP-Auswirkung |
...
| Mobile App Usage | Zielgruppe > Mobil > Nutzung mobiler Apps |
| Journey für mobile Apps | Zielgruppe > Mobil > Mobile App-Journey |
| Mobile-App-Metriken | Zielgruppe > Mobil > Mobile App Messaging |
| Leistung mobiler Apps | Zielgruppe > Mobil > Leistung mobiler Apps |
| Beibehaltung mobiler Apps | Zielgruppe > Mobil > Mobile App-Treue |
| Kampagnenleistung | Akquise > Kampagnen > Kampagnenleistung |
| Mobile Akquise | Akquise > Akquise für Mobilgeräte |
