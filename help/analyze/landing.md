---
description: Erläutert, wie die Landingpage sowohl Analysis Workspace als auch Reports & Analytics in einer einzigen Benutzeroberfläche und einem Zugriffspunkt unter dem Dach "Workspace"zusammenführt.
title: Adobe Analytics-Landingpage
role: User, Admin
...
# Adobe Analytics-Landingpage

Auf der Landingpage für Adobe Analytics kommen sowohl Analysis Workspace als auch Reports &amp; Analytics in einer einzigen Benutzeroberfläche zusammen und greifen unter dem Dach &quot;Workspace&quot;auf Zugriffspunkte zu. Es enthält eine Startseite des Projektmanagers, ein aktualisiertes Berichtsmenü, modernisierte Berichte und einen Lernabschnitt, der Ihnen dabei hilft, effektiver zu beginnen.
...
## Auf die Landingpage zugreifen {#access-landing}
...
| Weniger/mehr anzeigen | Blendet das Banner ein oder aus: ![Top-Banner](assets/top-banner.png) |
...
| Anheften-Symbol | Sie können Elemente anheften und *immer* werden oben in Ihrer Liste angezeigt. |
...
![Tab Berichte](assets/reports-tab.png)
...
Hier sind die Menüs und ihre Untermenüs. Wenn Sie einen bestimmten Bericht nicht finden können, führen Sie eine „Suche auf Seite“ durch, um ihn zu finden.
...
1. Klicken Sie rechts auf **[!UICONTROL Bericht öffnen]**.
   ...
   ![Seitenbericht](assets/pages-report.png)
