...
| events | events | [Ereigniszeichenfolge](https://experienceleague.adobe.com/docs/analytics/implementation/vars/page-vars/events/event-serialization.html?lang=de), mit derselben Syntax für die Variable s.events formatiert. Zum Beispiel: scAdd,event1,event7 |
...
| marketingCloudVisitorID | Nicht unterstützt | Experience Cloud ID. Siehe [Besucheridentifizierung](https://experienceleague.adobe.com/docs/id-service/using/home.html?lang=de) und den Experience Cloud-Besucher-ID-Service |
...
| transactionID | Nicht unterstützt | Allgemeiner Wert zur Bündelung von mehrkanaligen Benutzeraktivitäten für Berichtszwecke. Weitere Informationen finden Sie im [Benutzerhandbuch für Data Sources](https://experienceleague.adobe.com/docs/analytics/import/data-sources/datasrc-home.html?lang=de). |
