---
description: Die folgenden Metriken werden als Teil der appfigures-Integration synchronisiert.
seo-description: Die folgenden Metriken werden als Teil der appfigures-Integration synchronisiert.
seo-title: Metriken und Dimensionen
...
Die folgenden Metriken werden als Teil der appfigures-Integration synchronisiert.

| Metrik | Beschreibung |
|---|---|
| App Store-Downloads | Anzahl der mobilen Anwendungs-Downloads. |
| App Store-Käufe (in App) | Die Anzahl der In-App-Käufe. |
| App Store-Platzierung | Wird verwendet, um die durchschnittliche berechnete Metrik für appfigures zu definieren. Nicht direkt verwendet. |
| App Store-Divisor-Platzierung | Wird verwendet, um die durchschnittliche berechnete Metrik für appfigures zu definieren. Nicht direkt verwendet. |
| App Store-Bewertung | Wird verwendet, um die durchschnittliche berechnete Metrik für appfigures zu definieren. Nicht direkt verwendet. |
| Divisor für App Store-Bewertung | Wird verwendet, um die durchschnittliche berechnete Metrik für appfigures zu definieren. Nicht direkt verwendet. |
| App Store-Umsatz (in App) | Betrag des In-App-Umsatzes. |
| App Store-Umsatz (1 aus) | Der Betrag des Umsatzes, der dem Kauf einer App zugeordnet werden kann. |
| App Store Premium (in App) | Nicht mehr verwendet |
| App Store Premium (1 aus) | Nicht mehr verwendet |

Die folgenden reservierten Classification-Dimensionen werden vom Data Connectors-Assistenten für die reservierte evar für die Objekt-ID erstellt.

| Classification-Dimension | Beschreibung |
|---|---|
| Landesname | Der Name des Landes, das mit der App Store-Aktivität verknüpft ist. |
| Gerätename | Der Name des Mobilgeräts mit der App Store-Aktivität. |
| Appstore-Name | Der Name des Appstore, der die Aktivität gemeldet hat. |
| Anwendungsname | Der Name der mobilen Anwendung. |
| In-App-Name | Das in der Anwendung gekaufte Element. |
| Kategoriename | Primäre Kategorie der App im App Store. |
| Review-Titel | Titel des Reviews. |
| Review-Kommentar | Kommentar zur Überprüfung |
| Anwendungsversion | Version der Anwendung, die zum Generieren des Reviews verwendet wurde. |
| App Store-Benutzer | Autor (Benutzername) der Überprüfung. |

Die folgende errechnete Metrik wird vom Data Connectors-Assistenten erstellt:

<table id="table_504271ED1A954CCAA234738B07EDDF27"> 
 <thead> 
  <tr> 
   <th colname="col1" class="entry"> Berechnete Metrik </th> 
   <th colname="col2" class="entry"> Beschreibung </th> 
  </tr> 
 </thead>
 <tbody> 
  <tr> 
   <td colname="col1"> Durchschnittlicher App Store-Rang (numerisch) </td> 
   <td colname="col2"> <p>Die durchschnittliche App-Rangfolge. Diese berechnete Metrik wird mithilfe der folgenden Formel definiert: </p> <code> [App &amp; amp; nbsp; Store &amp; amp; nbsp; Rang] &amp; amp; nbsp; /&amp; amp; nbsp; [App &amp; amp; nbsp; Store &amp; amp; nbsp; Rang &amp; amp; nbsp; Divisor] </code> <p>Hinweis: Die Anzahl der Anwendungen pro Kategorie und Land variiert je nach App Store. Wenn Ihre Anwendung niedriger als dieser Schwellenwert ist, sind keine Anwendungsrangsätze verfügbar. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> App Store-Durchschnittsbewertung </td> 
   <td colname="col2"> Die durchschnittliche App-Bewertung. Diese berechnete Metrik wird mithilfe der folgenden Formel definiert: <code> [App &amp; amp; nbsp; Store &amp; amp; nbsp; Rating] &amp; amp; nbsp; /&amp; amp; nbsp; [App &amp; amp; nbsp; Store &amp; amp; nbsp; Bewertung &amp; amp; nbsp; Divisor] </code> </td> 
  </tr> 
 </tbody> 
</table>
...
Die folgende Tabelle zeigt, welche Berichtsdimensionen zu welchen Metriken gehören.
...
<table id="table_B9CF57EABE22449FBF1963E3F105E702"> 
 <tbody> 
  <tr> 
   ...
   <td> App Store-Käufe (In-App) </td> 
   <td> App Store-Platzierung </td> 
   <td> App Store-Divisor-Platzierung </td> 
   <td> App Store-Bewertung </td> 
   <td> Divisor für App Store-Bewertung </td> 
   <td> App Store-Umsatz (In-App) </td> 
   <td colname="col9"> App Store-Umsatz (einmalig) </td> 
   <td colname="col10"> App Store durchschnittl. Platzierung </td> 
   <td colname="col11"> Durchschnittl. App Store-Bewertung </td> 
  </tr> 
  <tr> 
   <td> Landesname </td> 
