...
user-guide-url: /content/help/de-DE/analytics/import/home.html
...
+ Data Connectors {#dataconnectors}
   ...
   + appFigures Data Connector for Adobe Analytics {#appfigures}
      ...
      + [Vor Aktivierung dieser Integration](data-connectors/appfigures-overview/appfigures-before-activation.md)
   ...
   + Aprimo Data Connector for Adobe Analytics {#aprimo}
      ...
      + [Integration aktivieren](data-connectors/aprimo-overview/t-aprimo-activate.md)
   ...
   + Datran Data Connector for Adobe Analytics {#datran}
      + [Data Connector für Adobe Analytics](data-connectors/datran-integration-overview/datran-integration-overview.md)
   ...
   + Demandbase Data Connector for Adobe Analytics {#demandbase}
      ...
      + [Standardmaße der Demandbase](data-connectors/demandbase-home/demandbase-standard-dimensions.md)
      + [Benutzerdefinierte Dimensionen der Demandbase](data-connectors/demandbase-home/demandbase-custom-dimensions.md)
   + DFA-Data Connectors für Adobe Analytics {#dfa}
      + [DFA-Data Connectors für Adobe Analytics](data-connectors/dfa-data-connector-analytics/dfa-data-connector-analytics.md)
   ...
   + DreamMail Data Connector for Adobe Analytics {#dreammail}
      ...
      + [Integration aktivieren](data-connectors/dreammail-overview/t-dreammail-activate.md)
   ...
   + Neolane Ozon Data Connector for Adobe Analytics {#neolane}
      ...
      + [Integration aktivieren](data-connectors/neolane-overview/neolane-activate.md)
   ...
   + optivo Broadmail Data Connector for Adobe Analytics {#optivo}
      ...
      + [Integration aktivieren](data-connectors/optivo-overview/optivo-activate.md)
   ...
   + Selligent Data Connector for Adobe Analytics {#selligent}
      + [Selektiver Data Connector für Adobe Analytics](data-connectors/selligent-overview/selligent-overview.md)
   ...
   + Silverpop Data Connector for Adobe Analytics {#silverpop}
      ...
      + [Vor Aktivierung dieser Integration](data-connectors/silverpop-overview/silverpop-before-activation/silverpop-before-activation.md)
