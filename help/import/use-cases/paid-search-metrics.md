...
1. Ordnen Sie nun diese neue Datenquelle den benutzerdefinierten Ereignissen zu, die wir in [Konfigurieren von Erfolgsereignissen](/help/admin/admin/c-success-events/t-success-events.md) erstellt haben.
