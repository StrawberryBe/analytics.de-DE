---
description: Erläutert die neue Landingpage, die Analysis Workspace und Reports & Analytics in einer zentralen Benutzeroberfläche zusammenfasst und so einen zentralen Zugriffspunkt bietet, den Workspace.
...
Die neue Landingpage für Adobe Analytics fasst Analysis Workspace und Reports &amp; Analytics in einer einzigen Benutzeroberfläche zusammen und bietet so einen zentralen Zugriffspunkt, den Workspace. Sie enthält eine neue Startseite für den Projekt-Manager, ein aktualisiertes Berichtsmenü und aktualisierte Berichte sowie einen neuen Lernbereich, der Ihnen dabei hilft, die ersten Schritte effektiver zu bewältigen.

Die neue Seite verbessert den Einstieg und führt Benutzer von Reports &amp; Analytics durch ein verbessertes Reporting-Erlebnis in Workspace.

>[!IMPORTANT]
>
>Diese Landingpage wird ab dem 21. Juli 2021 als offene Beta-Version angezeigt. Dies ist ein optionaler Ausgangspunkt. Wenn Sie es vorziehen, können Sie weiterhin die bisherige Landingpage verwenden, unabhängig davon, ob Sie in Workspace oder mit Berichten arbeiten. Wenn Sie sich für das Beta-Programm entscheiden, rufen Sie die Seite auf und klicken Sie oben auf dem Bildschirm auf **[!UICONTROL Feedback geben]**, um Ihr Feedback und alle Fehler, auf die Sie eventuell stoßen, zu melden. Sie können sich jederzeit vom Beta-Programm abmelden und wieder anmelden. Jede Arbeit, die in der Beta-Benutzeroberfläche ausgeführt wird, wird in das vorhandene/aktuelle Workspace-Erlebnis übernommen.

## Zugriff auf die neue Landingpage {#access-landing}

Nachdem Sie sich bei Adobe Experience Cloud und Analytics angemeldet haben, aktivieren Sie die Schaltfläche [!UICONTROL Neue Landingpage - Beta] in der unteren linken Ecke. Der Zugriff auf die Umschalter-Schaltfläche ist benutzerspezifisch innerhalb der Organisation und nicht unternehmensspezifisch.
...
* Änderungen am oberen Menü in Analytics: Das obere Menü **[!UICONTROL Berichte]** ist nicht mehr vorhanden. Die meisten Berichte befinden sich nun im Menü [!UICONTROL Berichte] in der linken Leiste.
...
* **[!UICONTROL Berichte]** beziehen sich auf alles, was von Adobe vorkonfiguriert wurde, z. B. Berichte in Reports &amp; Analytics und Vorlagen in Workspace. [!UICONTROL Berichte] sind auch Berichtsvorlagen, die Ihr Unternehmen für Sie erstellt hat.
* **[!UICONTROL Vorlagen]** werden nicht mehr als Begriff für die vordefinierten Workspace-Projekte von Adobe verwendet. Sie befinden sich nun unter [!UICONTROL Berichte].

## Navigieren Sie zur Registerkarte [!UICONTROL Projekte]. {#navigate-projects}

[!UICONTROL Projekte] fungieren als Startseite von [!UICONTROL Workspace]. Hier werden alle Workspace-Projekte angezeigt, einschließlich der mobilen Scorecards.
...
| Weniger/mehr anzeigen | Blendet das Banner ein oder aus: ![](assets/top-banner.png) |
| Leeres Projekt | Erstellt ein leeres [Workspace-Projekt](https://experienceleague.adobe.com/docs/analytics/analyze/analysis-workspace/home.html?lang=de), das Sie füllen können. |
...
| Schulungs-Tutorial öffnen | Öffnet das Workspace-Tutorial, das neue Benutzer schrittweise durch die Erstellung eines Projekts führt. |
...
| Anheften-Symbol | **Neu:** Sie können jetzt Elemente anheften, damit sie *immer* oben in der Liste angezeigt werden. |
...
| Spaltenauswahl | Wenn Sie Spalten zur Projektliste hinzufügen oder daraus entfernen möchten, können Sie dies tun, indem Sie sie auswählen oder abwählen. |
| &lt; (Schaltfläche „Zurück“) | Über diese Schaltfläche in einem Workspace-Projekt oder in einem Bericht gelangen Sie zurück zu Ihrer letzten Landingpage-Konfiguration. Die Seitenkonfiguration, die Sie beim Verlassen der Landingpage hatten, bleibt auch bei der Rückkehr erhalten. |
...
* Die meisten vordefinierten Berichte befanden sich zuvor in Adobe Analytics im oberen Menü [!UICONTROL Berichte]. Diese Berichte werden jetzt in [Analyse Workspace](https://experienceleague.adobe.com/docs/analytics/analyze/analysis-workspace/home.html?lang=de) angezeigt.
...
## Navigieren auf der neuen Seite

* Die Tour [!UICONTROL Workspace-Grundlagen] führt Sie direkt zu Workspace und zeigt Ihnen das Workspace-Layout und wo Sie die häufigsten Aktionen finden/durchführen können. Diese Tour kann auch jederzeit direkt in Workspace über das QuickInfo-Pop-over in der Kopfzeile des Bedienfelds neu gestartet werden.
...
## Häufig gestellte Fragen zur neuen Landingpage {#landing-faq}

| Frage | Antwort |
| --- | --- |
| Wo sind die Vorlagen, die ich gewohnt bin, in Workspace zu finden? | Diese Vorlagen sind auf der Registerkarte [!UICONTROL Berichte] gruppiert. |
| Kann ich die Beta-Version deaktivieren? | Sie können die Beta-Version jederzeit deaktivieren. |
| Wird die Arbeit, die ich in der Benutzeroberfläche des Beta-Programms erstelle, in das Workspace-Erlebnis für die Produktion übertragen? | Ja, alle in der Beta-Version durchgeführten Arbeiten werden in das alte/aktuelle Workspace-Erlebnis übernommen. |
| Werden meine aktuellen Reports &amp; Analytics-Favoriten übernommen? | Nein, sie werden NICHT übernommen. Alle Workspace-Projekt-Favoriten werden jedoch übernommen. |
...
| Können Administratoren diese neue Landingpage für ihre Benutzer bestimmen? | Nein, Administratoren können die neue Landingpage nicht im Namen von Benutzern festlegen. Die einzelnen Benutzer müssen den Umschalter selbst aktivieren. |
