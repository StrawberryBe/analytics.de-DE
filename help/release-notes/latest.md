...
| ----------- | ---------- | ------- | ---- |
| **Link-Freigabe für Projekte (keine Anmeldung erforderlich)** | Sie können jetzt schreibgeschützte Links zu Analysis Workspace-Projekten für Personen freigeben, die keinen Zugriff auf Adobe Analytics haben. Sie können Dinge mit Personen außerhalb Ihrer Organisation oder mit Personen innerhalb Ihrer Organisation teilen, die nicht für Adobe Analytics vorgesehen sind. [Weitere Informationen](https://experienceleague.adobe.com/docs/analytics/analyze/analysis-workspace/curate-share/share-projects.html?lang=de#share-public-link)<p>Diese Funktion ist standardmäßig aktiviert und kann von Systemadmins deaktiviert werden. [Weitere Informationen](https://experienceleague.adobe.com/docs/analytics/analyze/analysis-workspace/user-preferences.html?lang=de#company-preferences)</p> | 3. Mai 2023 | 7. Juni 2023 |
| **Klassifizierungssätze - Konsolidierung** | Kombinieren Sie Klassifizierungen aus verschiedenen Report Suites in einen konsolidierten Datensatz. Der konsolidierte Datensatz kann in Classification-Sets oder als Lookup-Datensatz in CJA verwendet werden. Weitere Informationen (in Kürze verfügbar) |  | 7. Juni 2023 |
| **Classification Sets - Rule Builder** | Verwenden Sie den Classification Rule Builder in der aktuellen Classification-Set-Architektur. Weitere Informationen (in Kürze verfügbar) |  | 7. Juni 2023 |
| **Classification Sets - automatisierter Import** | Sie können jetzt Classification-Set-Daten automatisch aus Cloud-Speicher-Zielen importieren. Weitere Informationen (in Kürze verfügbar) |  | 7. Juni 2023 |
| **Neue AppMeasurement-Variable** | Die Variable `doubleEncodeLinkParameters` berücksichtigt Edge-Fälle, in denen Implementierungen Multibyte-Zeichen in Linktracking-Variablen kodieren. Die meisten Implementierungen müssen diese Variable nicht definieren. Weitere Informationen (in Kürze verfügbar) |  | 7. Juni 2023 |
| **Sichere Ziele für den Daten-Feed-Export** | Daten-Feeds können jetzt an die folgenden Cloud-Speicher-Ziele gesendet werden:<ul><li>Amazon S3</li><li>Azure RBAC</li><li>Azure SAS</li><li>Google Cloud Platform</li></ul>Ziele, die zuvor verfügbar waren (FTP, SFTP, S3 und Azure Blob), werden nicht mehr empfohlen. [Weitere Informationen](https://experienceleague.adobe.com/docs/analytics/export/analytics-data-feed/create-feed.html?lang=de) |  | 12. Juni 2023 |
| **Bot-Reporting in Workspace** | Bot-Berichte sind jetzt in Analysis Workspace verfügbar. Diese Funktion wird durch mehrere Ergänzungen ergänzt:<ul><li>Eine neue Dimension: [Bot name](/help/components/dimensions/bot-name.md)</li><li>Zwei neue Metriken: [Bot-Seitenansichten](/help/components/metrics/bot-page-views.md) und [Bot-Vorkommen](/help/components/metrics/bot-occurrences.md).</li><li>Eine neue Vorlage für berechnete Metriken: [Verhältnis der Bot-Seitenansichten](/help/components/c-calcmetrics/cm-reference/default-calcmetrics.md)</li><li>Ein neuer Workspace-Bericht: Bot-Reporting</li></ul>Die neue Dimension und die neuen Metriken enthalten Daten, die ab März 2023 aufgestockt werden. |  | Juni 7,2023 |

{style="table-layout:auto"}

## Weitere neue oder aktualisierte Funktionen {#other}
...
| **Neue IPs, die von Adobe Analytics Data Feeds und der Data Warehouse Egress im London Data Center verwendet werden** | 27. April 2023 | Dies betrifft Kunden im London Data Center, die Daten-Feed-Anfragen und/oder Data Warehouse-Berichte an einen FTP-/SFTP-Dienst senden. Die folgenden IP-Adressbereiche sollten Ihrer Firewall-Konfiguration hinzugefügt werden, um den Zugriff zu ermöglichen: <ul><li>130.248.244.32/29</li><li>130.248.244.40/29</li></ul> |
