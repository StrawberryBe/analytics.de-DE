...
* [Versionshinweise zu Customer Journey Analytics für ](https://experienceleague.adobe.com/docs/analytics-platform/using/releases/latest.html)
* [Versionshinweise zu Media Analytics](https://experienceleague.adobe.com/docs/media-analytics/using/additional-resources/release-notes.html)
* Die neuesten Versionsupdates für [Adobe Experience Cloud-Produkte](https://business.adobe.com/de/products/adobe-experience-cloud-products.html)
...
| Die Anforderung von `x-proxy-global-company-id` -Kopfzeile für 2.0-API-Aufrufe | Die Adobe Analytics 2.0-APIs erfordern nicht mehr die `x-proxy-global-company-id` -Kopfzeile, da diese Informationen Teil der Endpunkt-URL sind. Sie können diese Kopfzeile nach wie vor einbeziehen, erhalten jedoch keinen Fehler mehr, wenn sie fehlt. | 20. April 2022 |
...
* Es wurde ein Fehler behoben, der dazu führte, dass aktuelle Versionen von Apple Safari und Microsoft Edge in der Suchtabelle des Browsertyps der Adobe nicht korrekt identifiziert wurden. Ähnlich wie bei [Browserversionen wurden aktualisiert](/help/components/dimensions/browser.md), werden bei Aktualisierungen der Suchtabellen des Browsertyps nur Daten korrigiert, die in Zukunft berücksichtigt werden. Die Suchtabellen für die Browserversion wurden am 20. April aktualisiert und die Suchtabellen für den Browsertyp wurden am 28. April aktualisiert. (AN-284872) AN-285753; AN-286257)
...
| **Aktualisierungen der ISO-Region 2022** | 11. März 2021 | Adobe plant, 2022 ISO-Regionsaktualisierungen durchzuführen für **10. Juni 2022**. Nach dieser Release erfolgen kleinere Aktualisierungen zu Geodaten. |
