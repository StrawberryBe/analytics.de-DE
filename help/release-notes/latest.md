...
| ----------- | ---------- | ---------- |
| **Neue Domain für systemgenerierte E-Mails** | 13. Juli 2022 | Adobe hat kürzlich die Absenderdomäne für E-Mails aus Workspace-Projekten, -Warnhinweisen und -Warnhinweisen aus `noreply@omniture.com` nach `noreply@adobe.com`. Fügen Sie diese neue E-Mail zu Ihrer Zulassungsliste hinzu, wenn Ihr Unternehmen nur bestimmte Absender zulässt. |
