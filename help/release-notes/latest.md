...
| **Unterstützung der Produktsyntax-Version von Merchandising-Variablen mit Edge Collection** | Sie können jetzt Merchandising-Variablen mit der Entsprechung der Produktsyntax festlegen, indem Sie die entsprechenden XDM-Felder festlegen. Siehe [Produktvariable](../implement/vars/page-vars/products.md) Weitere Informationen zur Web SDK-Syntax finden Sie unter `products` und [Analytics-Variablenzuordnung in Adobe Experience Edge](../implement/aep-edge/variable-mapping.md) für eine vollständige Liste der verfügbaren Variablen. | 15. Juni 2022 |
...
| **In Analytics-Verarbeitungsregeln verfügbare Verarbeitungsregeln für Mobile Services** | Die Adobe Mobile Services endet am 31. Dezember 2022. Vorhandene Verarbeitungsregeln, die von Adobe Mobile Services erstellt oder generiert wurden, werden automatisch zu Adobe Analytics-Verarbeitungsregeln migriert, von denen Sie sie bearbeiten und verwalten können. Sie können zwar angezeigt, aber erst dann in Mobile Services bearbeitet werden, wenn das Produkt nicht mehr verfügbar ist. Bei weiteren Fragen oder bezüglich Support wenden Sie sich bitte an die Kundenunterstützung von Adobe. [Weitere Infos](https://experienceleague.adobe.com/docs/mobile-services/using/eol.html?lang=en) | 15. Juni 2022 |
| **Klassifizierungssätze - Phase 1** | Diese schrittweise Veröffentlichung einer neuen Klassifizierung, die das Benutzererlebnis deutlich verbessert, verbessert die Sichtbarkeit der kundeneigenen Klassifizierungsdaten. Siehe [Klassifizierungssätze](../components/classifications/sets/overview.md) für weitere Informationen. | Eingeschränkte Tests beginnen am 15. Juni 2022, geschätzte allgemeine Verfügbarkeit Anfang 2023 |
