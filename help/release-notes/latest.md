...
| ----------- | ---------- | ------- |
| Keine neuen Funktionen in diesem Monat | Nicht angegeben | Siehe [Allgemeine Verfügbarkeit](https://experienceleague.adobe.com/docs/analytics/technotes/releases.html?lang=de) |
