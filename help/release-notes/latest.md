...
| **Verbesserter Workflow für die Web SDK-Migration** | Datastreams ordnet nun automatisch Felder aus dem Web SDK-Datenobjekt direkt Adobe Analytics zu. [Datenobjektzuordnung](/help/implement/aep-edge/data-var-mapping.md) ähnelt [XDM-Objektzuordnung](/help/implement/aep-edge/xdm-var-mapping.md), erfordert jedoch kein XDM-Schema. Dieser verbesserte Workflow bietet die folgenden Vorteile:<ul><li>Dadurch wird die Verwendung eines Schemas verzögert, bis Sie bereit sind, Daten an Adobe Experience Platform zu senden. Wenn in dieser Phase der Implementierungsmigration ein Schema erforderlich war, müssen Sie ein Schema verwenden, das auf Adobe Analytics-Feldern basiert. Adobe Experience Platform-Dienste wie Customer Journey Analytics haben kein Konzept von Props oder eVars. Ein Analytics-orientiertes Schema kann Schwierigkeiten verursachen, wenn Ihr Unternehmen in Zukunft ein eigenes Schema verwenden möchte.</li><li>Nachdem Sie die Implementierungsänderungen am Web SDK vorgenommen haben, ist Ihr Unternehmen besser in der Lage, von Adobe Analytics auf Customer Journey Analytics zu migrieren. Wenn Sie Daten mit dem Web SDK an Adobe Analytics senden, müssen Sie keine zusätzlichen Implementierungsänderungen vornehmen, um Daten an Adobe Experience Platform zu senden. Stattdessen können Sie die Datenvorbereitung verwenden, um Datenobjektfelder Ihrem XDM-Schema zuzuordnen.</li></ul>Siehe [Migration von der Adobe Analytics-Tag-Erweiterung zur Web SDK-Tag-Erweiterung](/help/implement/aep-edge/web-sdk/analytics-extension-to-web-sdk.md) und [Migration von AppMeasurement zum Web SDK](../implement/aep-edge/web-sdk/appmeasurement-to-web-sdk.md) für weitere Informationen. |  | April 2024 |
...
| **Verwenden Sie dieselben Cloud-Konten für [!UICONTROL Daten-Feeds], [!UICONTROL Data Warehouse], und [!UICONTROL Klassifizierungssätze]** | Von Ihnen erstellte Cloud-Konten und -Standorte können jetzt zum Exportieren von Daten verwendet werden (mit [!UICONTROL Daten-Feeds] und [!UICONTROL Data Warehouse]) und Importieren von Daten (mit [!UICONTROL Klassifizierungssätze]).<p> **Änderungen beim Konfigurieren von Konten:** Benutzer können [Konfigurieren von Cloud-Import- und -Exportkonten](https://experienceleague.adobe.com/en/docs/analytics/components/locations/configure-import-accounts) und [Konfigurieren von Cloud-Import- und -Exportspeicherorten](https://experienceleague.adobe.com/en/docs/analytics/components/locations/configure-import-locations) die für einen der folgenden Zwecke verwendet werden können:<ul><li>Importieren von Daten mit [!UICONTROL Klassifizierungssätze]</li><li>Exportieren von Daten mit [!UICONTROL Daten-Feeds]</li><li>Exportieren von Daten mit [!UICONTROL Data Warehouse].</li></ul><p>**Änderungen bei der Verwaltung von Konten und Standorten über [!UICONTROL Standorte] page**: Benutzer können die [Standorte](https://experienceleague.adobe.com/en/docs/analytics/components/locations/locations-manager) Seite (unter [!UICONTROL Komponenten] > Loc), um alle Konten und Standorte anzuzeigen und zu verwalten, die sie erstellen, unabhängig davon, wo sie erstellt wurden. <p>Zuvor wurde die Variable [!UICONTROL Standorte] Seite nur auf Konten angewendet, die zum Importieren von Daten mit [!UICONTROL Klassifizierungssätze].</p>**Änderungen bei der Verwaltung von Standorten aus [!UICONTROL Data Warehouse] oder [!UICONTROL Klassifizierungssätze]**<p>Bei der Verwaltung von Standorten innerhalb eines bestimmten Anwendungsbereichs ([!UICONTROL Data Warehouse] oder [!UICONTROL Klassifizierungssätze]), sind nur die Orte verfügbar, die in diesem spezifischen Anwendungsbereich erstellt wurden. Wenn Sie beispielsweise die [!UICONTROL Data Warehouse] nur Anwendungsbereich [!UICONTROL Data Warehouse] -Speicherorte verfügbar sind. Alle Konten sind weiterhin in jedem Anwendungsbereich verfügbar, unabhängig vom Anwendungsbereich, in dem sie erstellt wurden. Bisher waren alle Konten und Standorte in jedem Anwendungsbereich verfügbar, unabhängig vom Anwendungsbereich, in dem sie erstellt wurden. Dies gilt auch bei der Anzeige der [!UICONTROL Daten-Feeds] Anwendungsbereich. | | 17. April 2024 |
