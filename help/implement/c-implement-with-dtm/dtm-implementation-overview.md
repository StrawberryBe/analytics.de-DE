...
1. [Eine Webeigenschaft erstellen](/help/implement/c-implement-with-dtm/t-create-web-property.md).
1. [Hosting-Optionen konfigurieren](/help/implement/c-implement-with-dtm/t-configure-hosting.md).
1. [Jeder verwalteten Seite Kopf- und Fußzeilencode hinzufügen](/help/implement/c-implement-with-dtm/c-headers-footers/t-header-footer-code.md).
1. [Adobe Analytics-Werkzeug hinzufügen](/help/implement/c-implement-with-dtm/c-aa-tool/analytics-dtm.md).
1. Erstellen Sie [Datenelemente](/help/implement/c-implement-with-dtm/t-data-element.md), [Regeln und Bedingungen](/help/implement/c-implement-with-dtm/c-rules/t-rules-create.md) sowie [Aktionen](/help/implement/c-implement-with-dtm/c-rules/t-rules-actions.md).
