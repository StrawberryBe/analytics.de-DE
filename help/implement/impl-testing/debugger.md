...
In Edge können Sie keine Lesezeichen manuell erstellen, jedoch können Sie eine Lesezeichen-URL bearbeiten.
...
In Safari können Sie keine Lesezeichen manuell erstellen, jedoch können Sie eine Lesezeichen-URL bearbeiten.
...
* **Benutzerfreundliches Format:** Schaltet das Anzeigeformat zwischen hilfreichen Beschriftungen und Rohabfragezeichenfolgen in einer Bildanforderung um. Weitere Informationen finden Sie unter Abfrageparameter [Datenerfassungs-Abfrageparameter](../js-implementation/data-collection/query-parameters.md).
