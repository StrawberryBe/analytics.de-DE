...
Die `offlineHitLimit` Variable legt eine Obergrenze für die Anzahl der Treffer fest, die das Gerät lokal speichert. This variable only works if [`trackOffline`](trackoffline.md) is enabled.
