...
## Hierarchien mit dem Web SDK

Hierarchien sind [für Adobe Analytics zugeordnet](https://experienceleague.adobe.com/docs/analytics/implementation/aep-edge/variable-mapping.html?lang=de) unter den XDM-Feldern `_experience.analytics.customDimensions.hierarchies.hier1` nach `_experience.analytics.customDimensions.hierarchies.hier5`.

## Hierarchien mit der Adobe Analytics-Erweiterung
...
6. Suchen Sie die [!UICONTROL Hierarchie] Abschnitt.

Sie können einen Hierarchiewert auf eine statische Zeichenfolge setzen oder auf ein Datenelement verweisen. Sie können auch das gewünschte Trennzeichen festlegen. Stellen Sie sicher, dass das hier eingestellte Trennzeichen mit dem in den Report Suite-Einstellungen festgelegten Trennzeichen übereinstimmt.
