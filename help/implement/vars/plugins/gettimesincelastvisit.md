...
Mit dem `getTimeSinceLastVisit` Plug-in können Sie verfolgen, wie lange ein Besucher nach dem letzten Besuch zu Ihrer Site zurückgekehrt ist.
...
Die `getTimeSinceLastVisit` Methode verwendet keine Argumente. Gibt die Zeit zurück, die seit dem letzten Besuch des Besuchers der Site verstrichen ist und im folgenden Format zusammengefasst wurde:
...
* Wenn ein Besucher vor oder nach zwei Jahren noch nicht besucht hat, wird der Wert auf `"New Visitor"`&quot;Wert&quot;gesetzt.
