...
Sie können das [Adobe Experience Platform Web SDK](https://experienceleague.adobe.com/docs/experience-platform/web-sdk/home.html) verwenden, um Daten an Adobe Analytics zu senden. Diese Implementierungsmethode funktioniert durch die Übersetzung der [Experience-Datenmodell (XDM)](https://experienceleague.adobe.com/docs/experience-platform/xdm/home.html?lang=de) in ein von Analytics verwendetes Format. Sie können Daten mithilfe der Web SDK-JavaScript-Bibliothek oder der Web SDK-Tag-Erweiterung an das Adobe Experience Platform Edge Network senden.
