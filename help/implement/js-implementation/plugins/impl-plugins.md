...
seo-description: Bei AppMeasurement für JavaScript-Plug-ins handelt es sich um Programme oder Funktionen, die verschiedene erweiterte Funktionen durchführen.
seo-title: Plug-ins für Implementierungen verwenden
solution: Analytics
subtopic: Plug-ins
...
Bei AppMeasurement für JavaScript-[Plug-ins](/help/implement/js-implementation/c-appmeasurement-js/plugins-support.md) handelt es sich um Programme oder Funktionen, die verschiedene erweiterte Funktionen durchführen.
