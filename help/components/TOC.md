...
+ Dimensionen {#dimensions}
   ...
   + [Browsertyp](dimensions/browser-type.md)
   + [Browserbreite](dimensions/browser-width.md)
   ...
   + [Tage vor dem ersten Kauf](dimensions/days-before-first-purchase.md)
   + [Tage seit dem letzten Kauf](dimensions/days-since-last-purchase.md)
   ...
   + [Ausstiegslink](dimensions/exit-link.md)
   + [First Touch-Kanal](dimensions/first-touch-channel.md)
   + [First Touch-Kanal](dimensions/first-touch-detail.md)
   ...
   + [Last Touch-Kanal](dimensions/last-touch-channel.md)
   + [Letztkontakt Kanal](dimensions/last-touch-detail.md)
   + [Marketing-Kanal](dimensions/marketing-channel.md)
   + [Minute](dimensions/minute.md)
   + [Mobile Dimensionen](dimensions/mobile-dimensions.md)
   ...
   + [Ursprüngliche verweisende Domäne](dimensions/original-referring-domain.md)
   + [„Seiten-URL“](dimensions/page-url.md)
   + [Seite](dimensions/page.md)
   + [Seiten nicht gefunden](dimensions/pages-not-found.md)
   + [Gebührenpflichtige Suche](dimensions/paid-search.md)
   + [Beständige Cookie-Unterstützung](dimensions/persistent-cookie-support.md)
   ...
   + [Site-Abschnitt](dimensions/site-section.md)
   + [Zeit vor dem Ereignis](dimensions/time-prior-to-event.md)
   + [Besuchszeit pro Seite](dimensions/time-spent-on-page.md)
   + [Zeit pro Besuch](dimensions/time-spent-per-visit.md)
   + [Rückverfolgungscode](dimensions/tracking-code.md)
   + [Gründe für die Rückverfolgung des Ausschluss](dimensions/tracking-opt-out-reason.md)
   + [US-DMA](dimensions/us-dma.md)
   + [US-Bundesstaaten](dimensions/us-states.md)
   + [Besuchstiefe](dimensions/visit-depth.md)
   + [Besuch-Nr.](dimensions/visit-number.md)
...
+ Metriken {#metrics}
   ...
   + [Durchschnittliche Seitentiefe](metrics/average-page-depth.md)
   + [Durchschnittliche Ansichten pro Besuch](metrics/average-page-views-per-visit.md)
   + [Durchschnittliche Sitzungslänge](metrics/average-session-length.md)
   + [Durchschnittliche Zeit auf der Site](metrics/average-time-on-site.md)
   + [Absprungrate](metrics/bounce-rate.md)
   + [Absprünge](metrics/bounces.md)
   + [Zusätze zum Warenkorb](metrics/cart-additions.md)
   + [Entnahmen aus Warenkorb](metrics/cart-removals.md)
   + [Warenkorb-Ansichten](metrics/cart-views.md)
   + [Warenkorb](metrics/carts.md)
   + [Checkouts](metrics/checkouts.md)
   + [Inhaltsgeschwindigkeit](metrics/content-velocity.md)
   ...
   + [Mobile Ansichten](metrics/mobile-views.md)
   ...
   + [Übersicht über die Besuchszeit](metrics/time-spent.md)
   + [Gesamtbesuchszeit in Sekunden](metrics/total-seconds-spent.md)
   + [Individuelle Besucher](metrics/unique-visitors.md)
