...
* Überprüfen Sie die konzeptbezogenen Informationen unter [Erste Schritte mit Marketingkanälen](/help/components/c-marketing-channels/c-getting-started-mchannel.md) und [Info zu Marketingkanalberichten](/help/components/c-marketing-channels/c-overview.md).
