...
2. **[!UICONTROL Verweisende Stelle stimmt mit internen URL-Filtern]** überein und **[!UICONTROL Ist erste Seite des Besuchs]**. (Siehe [Internal](/help/components/c-marketing-channels/c-faq.md).)
