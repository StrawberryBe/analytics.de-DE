...
Instanzen werden für alle Treffertypen gezählt, jedoch nicht gezählt, wenn ein Wert für eine Variable bei einem nachfolgenden Treffer aufgrund der Persistenz aufgezeichnet wird.
