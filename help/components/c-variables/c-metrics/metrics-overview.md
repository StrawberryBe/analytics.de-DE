...
>[!IMPORTANT]
>
>Analysis Workspace unterscheidet sich nicht mehr zwischen Traffic- und Konversionsmetriken. Hence, the metric type is only relevant to tolls such as Reports &amp; Analytics, Web Services 1.4, and Report Builder.)
...
| Vorfälle | Die Frequenz, mit der ein bestimmter Wert erfasst wird, plus die Anzahl der Seitenansichten, für die dieser Wert weiter besteht. Das heißt, Vorfälle sind die Summe der Seitenansichten und der Seitenereignisse. Vorfälle sind nur in Ad Hoc Analysis verfügbar. | Not available in Reports &amp; Analytics, Web Services 1.4, or Report Builder |
