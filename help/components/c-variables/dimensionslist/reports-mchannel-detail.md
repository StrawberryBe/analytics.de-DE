...
* Zusätzlich zu den verschiedenen Kanälen, die mit Standardmethoden erfasst werden, können Sie [Offlinedatenquellen](/help/components/c-marketing-channels/c-getting-started-mchannel.md) heranziehen.
* Mit den [Classifications](/help/components/c-classifications2/c-classifications.md) in diesem Bericht können Sie Zeileneinträge umbenennen und zusammenfassen. Weitere Details zu Marketingkanälen finden Sie [hier](/help/components/c-marketing-channels/classifictions-mchannel.md).
