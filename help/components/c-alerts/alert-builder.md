...
![](assets/alert_builder.png)Geben Sie einen Namen für den Warnhinweis an. Der Warnhinweisname könnte den Namen des Berichts oder den Schwellenwert einer Metrik enthalten.
...
Die Telefonnummer muss über ein vorangestelltes Pluszeichen („+“) und eine [Landesvorwahl[#$tu24] verfügen.
...
## Beispiel: Wenn Sie die Zeitgranularität auf „Stündlich“ festlegen, kann Ihnen die Vorschau verraten, dass der Warnhinweis zu einer bestimmten Metrik während der letzten 30 oder 31 Tage x-mal ausgelöst worden wäre. {#section_10D75BA7B77E4C5FAF58A719C082E070}
