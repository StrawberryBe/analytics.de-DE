...
* **[!UICONTROL Ad-hoc-Analysen]**: Segmente [in Ad-hoc-Analysen](../../../components/c-segmentation/c-segmentation-workflow/seg-build.md#section_E440630183D64999BA2369D1B8048AA6)erstellen.
...
1. **[!UICONTROL Tags]**: Markieren Sie [das Segment](../../../components/c-segmentation/c-segmentation-workflow/seg-workflow.md#concept_CD892CEB326C4986A1B67487052DBA50) , das Sie erstellen, indem Sie aus einer Liste vorhandener Tags wählen oder ein neues Tag erstellen.
...
1. **[!UICONTROL Anzeigen]**: (Auswahl oberster Behälter.) Lets you select the top-level [container](../../../components/c-segmentation/seg-overview.md#concept_A38E7000056547399E346559D85E2551) ([!UICONTROL Visitor], [!UICONTROL Visit], [!UICONTROL Hit]). Standardmäßig ist der Trefferbehälter der Behälter der obersten Ebene.
