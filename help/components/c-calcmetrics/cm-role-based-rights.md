...
<table id="table_13F72FD90C964B86BD4B51E6F51ED292"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col02"> Administratoren können berechnete Metriken sowie <a href="https://experienceleague.adobe.com/docs/analytics/admin/user-product-management/user-groups/groups.html"  >Gruppen</a> erstellen, um die Rechte von Benutzern zur Erstellung berechneter Metriken einzuschränken. </td> 
