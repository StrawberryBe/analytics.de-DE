...
Wenn ein Datensubjekt eine Anfrage zusammen mit einer Kennung (benutzerdefinierte Variable - Prop oder eVar) sendet, prüft Adobe Analytics dann den gesamten gespeicherten Verlauf der Daten, die für die jeweilige ID erfasst wurden. Weitere Informationen zum Konfigurieren von benutzerdefinierten IDs, die in Props oder eVars von Analytics gespeichert sind, finden Sie im Abschnitt [Analytics-Dokumentation zu Namespaces](/help/admin/c-data-governance/data-labeling/gdpr-namespaces.md).
