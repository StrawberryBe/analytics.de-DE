...
| **Schritt 2**: Legen Sie Ihre Richtlinie zur Datenaufbewahrung fest. | Es muss eine Datenaufbewahrungsrichtlinie vorhanden sein, damit Adobe Datendatenzugriffszugriffsanforderungen/Löschungsanfragen bereitstellen kann.  Weitere Informationen finden Sie unter [Häufig gestellte Fragen zur Datenaufbewahrung in Analytics.](/help/technotes/data-retention.md) |
| **Schritt 3**: Machen Sie sich mit den Bezeichnungen "DULE/Data Privacy", Adobe Analytics-IDs, Namespaces und ID-Erweiterung vertraut. | Lesen Sie hierzu folgende Themen dieser Dokumentation:<ul><li>[Datenschutzbezeichnungen für Analytics-Variablen](/help/admin/c-data-governance/gdpr-labels.md)</li><li>[Best Practices für Beschriftungen](/help/admin/c-data-governance/gdpr-analytics-ids.md)</li></ul> |
...
| **Schritt 6**: Anzeigen und Verwalten der Datenschutzeinstellungen Ihrer Report Suite. | Befolgen Sie die Anweisungen unter [Data-Governance-Einstellungen von Report Suites anzeigen.](/help/admin/c-data-governance/gdpr-view-settings.md) |
