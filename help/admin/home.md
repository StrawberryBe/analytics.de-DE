...
* Adobe Admin Console: In diesem Bereich können Sie Experience Cloud-Werkzeuge bereitstellen und Benutzerberechtigungen verwalten. It is located at [adminconsole.adobe.com](https://adminconsole.adobe.com).
* Analytics Admin Console: In diesem Bereich können Sie Report Suites und Variablen verwalten. Der Zugriff darauf erfolgt über „Admin“ in der oberen Kopfzeile von Adobe Analytics.
...
Dieses Handbuch behandelt nur wenige der allgemeinen Funktionen der Adobe Admin Console. Siehe stattdessen [Admin-Konsole](https://helpx.adobe.com/enterprise/using/admin-console.html) im Enterprise-Benutzerhandbuch.
