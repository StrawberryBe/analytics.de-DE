...
seo-title: Berechtigungen für Analytics-Werkzeuge anpassen
solution: Analytics
subtopic: Benutzer und Gruppen
title: Berechtigungen für Analytics-Werkzeuge anpassen
topic: Admin Tools
...
# Berechtigungen für Analytics-Werkzeuge anpassen
...
**[!UICONTROL Benutzerverwaltung]** &gt; **[!UICONTROL Gruppen]** &gt; **[!UICONTROL Zugriff auf Bericht]** &gt; **[!UICONTROL Analytics-Tools]** &gt; **[!UICONTROL Anpassen]**

>[!NOTE]
>
>Im Herbst 2016 (20. Oktober) wurden Änderungen an der Gruppenverwaltung vorgenommen. See [Administrative Changes - Fall 2016](../../../admin/user-management2/c-user-management/permissions-changes.md#concept_86581595B86B47D5B8F90282FC3E31EF) for a summary of changes.
...
|--- |--- |
| **Allgemein** |  |
| [Rechnungsstellung](../../../admin/admin/billing-admin.md) | Gewährt Zugriff auf Rechnungsdaten, einschließlich Traffic-Daten aller Report Suites. |
...
| [ClickMap](https://marketing.adobe.com/resources/help/en_US/sc/user/clickmap.html) | Zeigt ClickMap immer im [!UICONTROL Tool-Menü] in der Kopfzeile an.<br>(**Hinweis:** Adobe empfiehlt die Verwendung von [Activity Map](https://marketing.adobe.com/resources/help/en_US/analytics/activitymap/activitymap-enable.html).) |
...
| [Projekte im Analysis Workspace erstellen/kuratieren](https://marketing.adobe.com/resources/help/en_US/analytics/analysis-workspace/curate.html) | Ermöglicht es Benutzern, in Analysis Workspace Projekte zu erstellen und zu betreuen. |
