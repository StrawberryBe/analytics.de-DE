...
| [Aktuelle Daten](https://experienceleague.adobe.com/docs/analytics/analyze/reports-analytics/current-data.html?lang=de) | Ermöglicht die Verwendung der Funktion „Aktuelle Daten“ für Berichte. |
...
| Zugriff auf [Analysis Workspace](https://experienceleague.adobe.com/docs/analytics/analyze/analysis-workspace/home.html?lang=de) | Gewährt Benutzern Zugriff auf Analysis Workspace, die für [!DNL Adobe Analytics] empfohlene Berichtsschnittstelle. |
| [Reports &amp; Analytics](/help/analyze/reports-analytics/getting-started.md) | Gewährt Benutzern Zugriff auf Reports &amp; Analytics. |
...
| [Erstellung von Segmenten](https://experienceleague.adobe.com/docs/analytics/components/segmentation/seg-home.html?lang=de) | Ermöglicht es Benutzern, Segmente zu erstellen. |
| **Data Connectors** |  |
