...
>[!NOTE] Aufgrund der großen Anzahl möglicher Berechtigungskombinationen können wir keine Dokumentation bereitstellen, die alle API-Methoden beschreibt, die in jeder beliebigen Berechtigungskombination verwendet werden können. Im Allgemeinen haben Nichtadministratoren, denen der Zugriff auf Web-Services gewährt wurde, nur Lesezugriff auf API-Methoden. Sie haben keinen Schreibzugriff auf Methoden.

Da die API und Schnittstelle dasselbe Berechtigungssystem verwenden, sind unabhängig davon, welche Berechtigungen ein bestimmter Nichtadministrator auf der Oberfläche (Adobe Admin-Konsole) erhalten hat, dieselben Berechtigungen wie der Benutzer in der API.
...
<table id="table_D1DB0DE37752450BBCCA44DB760BB505"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> <b>Administratorzugriff:</b> Vordefinierte Gruppen sind für Administratoren nicht mehr erforderlich. Administratoren haben jetzt Zugriff auf alle Elemente (Tools, Metriken, Dimensionen) sowie auf Webdienst, ReportBuilder, Aktivität Map und Ad-hoc-Analysen. </p> <p>In Zukunft sollen Gruppen den Zugriff auf nicht-administrative Benutzer gewähren oder einschränken. </p> <p> <b>Benutzerspezifische Gruppen:</b> Vordefinierte Gruppen wurden durch benutzerdefinierte Gruppen ersetzt. Vorhandene vordefinierte Gruppen werden unter demselben Gruppennamen in benutzerspezifische Gruppen migriert. Alle von Ihnen erstellten benutzerspezifischen Gruppen, einschließlich ihrer Einstellungen, werden beibehalten. Sie werden jedoch feststellen, dass sich der Speicherort der Einstellungen verschoben hat. Die Unternehmenseinstellungen beispielsweise (früher in der Anpassung der Admin Console) befinden sich nun in der <a href="/help/admin/user-management2/c-customize-report-access/groups-analytics-tools.md">Anpassen der Analytics-Tools</a>. </p> <p> Benutzer mit <span class="term">Zugriff auf Berichte</span> wurden zu einer benutzerdefinierten Gruppe migriert, die Zugriff auf Folgendes hat: </p> 
    <ul id="ul_696A9243F5FD4AF187352C2F4B1CFDC2"> 
     ...
     <li id="li_AFFB58C7FB644AC8A85E2D76BA7D51F5">Zugriffsberechtigung für Analyse Workspace </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Sie können Berechtigungen anpassen, um den Zugriff auf Dimensionen (zusätzlich zu den Metriken) einzuschließen oder auszuschließen. </p> 
...
Hier finden Sie wichtige neue Informationen zu neuen und geplanten Updates und deren Auswirkungen auf Ihre administrative Umgebung.
...
<table id="table_1E93F45C66E841E6882FB602509F30A3"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p>Muss ich irgendwas tun, um Benutzer zu migrieren? </p> </td> 
   <td colname="col2"> <p>Nein, alle Berechtigungen werden transparent migriert. </p> <p> 
     <ul id="ul_654F85286EC04416B3E0BA725EBE10AD"> 
      <li id="li_8050B8941F794103B82A0ADF0930D216">Alle aktuellen Traffic-Berichte in einer benutzerspezifischen Gruppe werden automatisch in die neue Dimension-Kategorie migriert. </li> 
      <li id="li_B97079DB29A346B98D066F11AB7F94AF">Wenn für eine benutzerspezifische Gruppe bereits Metriken aktiviert sind, erhalten diese automatisch alle Dimensionen, für die neue Berechtigungen erteilt werden können (eVars und Lösungsvariablen). </li> 
      <li id="li_F1219EF490DA473BA15F2B215F2995AE"> Eine benutzerspezifische Gruppe mit mindestens einer Metrik erhält automatisch Zugriff auf alle eVars und andere inhaltsbezogene Dimensionen <b>mit Ausnahme</b> der neu verfügbaren Traffic-Dimensionen (früher Traffic-Berichte). </li> 
      ...
      <li id="li_2FCD9254FC3C4FD7871EEF9453E5CE1E">Für jede benutzerspezifische Gruppe mit Metriken werden alle Analytics-Lösungs-Ereignis als neue Metriken hinzugefügt. </li> 
      <li id="li_34C4560769B64F28A4E83BAE71065DCC">Jeder Benutzer, der Teil von Zugriff auf alle Berichte war, wird der neuen benutzerdefinierten Gruppe hinzugefügt. Der Zugriff auf alle Berichte ist nicht mehr möglich. </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>Was wird sich nicht ändern? </p> </td> 
   <td colname="col2"> <p>Besucher-Attribute werden weiterhin nicht autorisiert. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
>[!NOTE] *`migrated user`* und *`Experience Cloud user`* sind Benutzer, die eine Einladungs-E-Mail für die Mitgliedschaft in Experience Cloud angenommen haben. Wird diese Einladung nicht angenommen, sind die Benutzer weiterhin Benutzer von Analytics und können nicht über die Admin Console verwaltet werden. (Die Ausnahme ist, wenn die Migration [Enterprise- oder Federated IDs](https://helpx.adobe.com/de/enterprise/using/set-up-identity.html)verwendet. In diesem Fall wird der Benutzer migriert, wenn der Administrator Benutzer für einzelne Benutzer migriert.)

<table id="table_B68FD00FC5D24823A86BB69558C0327C"> 
 <thead> 
  <tr> 
   <th colname="col1" class="entry"> Aufgabe </th> 
   <th colname="col2" class="entry"> Nicht migrierende Anmeldungs-Firma </th> 
   <th colname="col3" class="entry"> Derzeit Firma migrieren </th> 
   <th colname="col4" class="entry"> Firma zur Anmeldung abgeschlossen </th> 
  </tr> 
 </thead>
 <tbody> 
  <tr> 
   <td colname="col1"> Benutzer erstellen </td> 
  ...
  <tr> 
   ...
   <td colname="col4"> <p> <a href="https://adminconsole.adobe.com/enterprise/"> Admin Console</a> </p> <p> Admin Tools - Die Bearbeitung ist auf die Verwaltung von API-Schlüsseln und das Löschen/Übertragen von Assets beschränkt. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> Löschen eines Benutzers </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> <b>Experience Cloud: </b> marketing.adobe.com <span class="filepath"></span>. Nur für Experience Cloud-Benutzer verfügbar. </p> <p> <b>Analytics (veraltet):</b> <span class="filepath">sc.omniture.com</span>. Nur für Analytics-Benutzer und für Experience Cloud-Benutzer mit deren Analytics-Anmeldeinformationen </p> </td> 
   <td colname="col3"> <p> <span class="filepath"> marketing.adobe.com</span> - nur für Experience Cloud-Benutzer verfügbar. </p> <p> <span class="filepath">sc.omniture.com</span> – für Benutzer, die ausschließlich Analytics verwenden, sowie für Benutzer von Experience Cloud mit deren Analytics-Anmeldedaten. </p> <p>Während der Migration können Administratoren die Anmeldung über <span class="filepath">omniture.com</span> für bestimmte Benutzer deaktivieren. </p> </td> 
