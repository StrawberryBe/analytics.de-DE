...
1. Laden Sie in der Admin Console eine Liste der Benutzer der Admin Console herunter:
   ...
   1. Gehen Sie zu [Admin Console](http://adminconsole.adobe.html/#) &gt; **[!UICONTROL Benutzer]** und klicken Sie auf [Benutzerliste in CSV exportieren](https://helpx.adobe.com/de/enterprise/using/users.html).
