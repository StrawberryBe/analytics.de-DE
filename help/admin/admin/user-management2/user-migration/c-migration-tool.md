 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> 
    ...
    </ul> <p>Diese stehen Ihnen im Analytics User Management weiterhin zur Verfügung. </p> <p>Siehe <a href="/help/admin/admin/user-management2/user-migration/c-migration-tool.md"> Nicht unterstützte Analytics-Funktionen in Adobe Admin Console</a> für weitere Informationen. </p> </td> 
  </tr> 
  <tr> 
