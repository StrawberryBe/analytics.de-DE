...
|---|---|
| [!UICONTROL Name] | Der Name der Classification. |
| [!UICONTROL Optionen (nur Text)] | Erstellt eine Liste mit für diese Classification verfügbaren Werten. [!UICONTROL Optionen] kann zusammen mit Kampagnenvariablen verwendet werden, um den Benutzern eine Liste mit unterstützten Werten für die Classification im [!UICONTROL Kampagnen-Manager] bereitzustellen. |
